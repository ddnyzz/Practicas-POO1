...
#13/02/2025
    ...
    #valor string a cada dia
    #funcion donde reciba el valor de contenido de enum 
    #print valor correcto -si es igual -si no es igual enviar error (comparar tipo de dato)
    #delimitar el numero de petiociones a 9
#---------------------------------------------------------
"""
